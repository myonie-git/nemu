...
#define testimmI() do { *imm = SEXT(BITS(i, 31, 31), 1) << 11| BITS(i, 30, 20);} while(0)
...
#define immJ() do { *imm = (SEXT(BITS(i, 31, 31), 1) << 20) | (BITS(i, 19, 12) << 12) | (SEXT(BITS(i, 11, 11), 1) << 11) | (SEXT(BITS(i, 30, 20), 1) << 1); } while(0)

// BITS(i, 31, 31) << 20 | BITS(i, 19, 12) << 12 | BITS(i, 11, 11) << 1| BITS(i, 30, 20) << 1
