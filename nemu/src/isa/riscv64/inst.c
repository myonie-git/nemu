...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(dest) = (__uint128_t)((sword_t)src1 * (sword_t)src2) >> 64);
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, R(dest) = (__uint128_t)((sword_t)src1 * src2) >> 64);
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R, R(dest) = (__uint128_t)(src1 * src2) >> 64);
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(dest) = src1 / (sword_t)src2);
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, R(dest) = src1 / src2);
  INSTPAT("0000001 ????? ????? 101 ????? 01110 11", divw   , R, R(dest) = SEXT(src1 / (sword_t)src2, 32));
  INSTPAT("0000001 ????? ????? 100 ????? 01110 11", divuw  , R, R(dest) = SEXT(src1 / src2, 32));
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 01110 11", sllw   , R, R(dest) = SEXT((uint32_t)src1 << (src2 & 0x3f), 32));
  INSTPAT("0100000 ????? ????? 101 ????? 01100 11", sra    , R, R(dest) = ((sword_t)src1) >> (src2 & 0x3f));
  INSTPAT("0100000 ????? ????? 101 ????? 01110 11", sraw   , R, R(dest) = SEXT((int32_t)src1 >> (src2 & 0x3f), 32));
  INSTPAT("0000000 ????? ????? 101 ????? 01100 11", srl    , R, R(dest) = src1 >> (src2 & 0x3f));
  INSTPAT("0000000 ????? ????? 101 ????? 01110 11", srlw   , R, R(dest) = SEXT((uint32_t)src1 >> (src2 & 0x3f), 32));
  ...
  /*RV64V*/
  INSTPAT("??????? ????? ????? 000 ????? 00001 11", vld    , N, (decode_exec_rvv_load(s)));
  INSTPAT("??????? ????? ????? 101 ????? 00001 11", vld    , N, (decode_exec_rvv_load(s)));
  INSTPAT("??????? ????? ????? 110 ????? 00001 11", vld    , N, (decode_exec_rvv_load(s)));
  INSTPAT("??????? ????? ????? 111 ????? 00001 11", vld    , N, (decode_exec_rvv_load(s)));
  
  INSTPAT("??????? ????? ????? 000 ????? 01001 11", vsd    , N, (decode_exec_rvv_store(s)));
  INSTPAT("??????? ????? ????? 101 ????? 01001 11", vsd    , N, (decode_exec_rvv_store(s)));
  INSTPAT("??????? ????? ????? 110 ????? 01001 11", vsd    , N, (decode_exec_rvv_store(s)));
  INSTPAT("??????? ????? ????? 111 ????? 01001 11", vsd    , N, (decode_exec_rvv_store(s)));
