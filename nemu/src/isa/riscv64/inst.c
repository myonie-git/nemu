...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 01110 11", sllw   , R, R(dest) = SEXT(src1 << (src2 & 0x3f), 32));
  INSTPAT("0100000 ????? ????? 101 ????? 01100 11", sra    , R, R(dest) = ((word_t)src1) >> src2 & 0x3f);
  INSTPAT("0100000 ????? ????? 101 ????? 01110 11", sraw   , R, R(dest) = SEXT((word_t)src1 >> src2 & 0x3f, 32));
  INSTPAT("0000000 ????? ????? 101 ????? 01100 11", srl    , R, R(dest) = src1 >> (src2 & 0x3f));
  INSTPAT("0000000 ????? ????? 001 ????? 01110 11", srlw   , R, R(dest) = SEXT(src1 >> (src2 & 0x3f), 32));
  ...
  INSTPAT("010000? ????? ????? 101 ????? 00100 11", srai   , I, R(dest) = (word_t)src1 >> (imm & 0x3f));
  INSTPAT("010000? ????? ????? 101 ????? 00110 11", sraiw  , I, R(dest) = SEXT((word_t)src1 >> (imm & 0x3f), 32));
  INSTPAT("000000? ????? ????? 101 ????? 00100 11", srli   , I, R(dest) = src1 >> (imm & 0x3f));
  INSTPAT("000000? ????? ????? 101 ????? 00110 11", srliw  , I, R(dest) = SEXT(src1 >> (imm & 0x3f), 32));
