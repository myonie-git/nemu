...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  __VA_ARGS__ ; \
    ...
    INSTPAT("000001 ? ????? ????? 000 ????? 00010 11", madd   , V, );
    INSTPAT("000001 ? ????? ????? 001 ????? 00010 11", madd   , V, );

    INSTPAT("000010 ? ????? ????? 000 ????? 00010 11", msub   , V, );
    INSTPAT("000010 ? ????? ????? 001 ????? 00010 11", msub   , V, );
    ...
    INSTPAT("000010 ? ????? ????? 010 ????? 00010 11", mewmul   , V, );
    INSTPAT("000010 ? ????? ????? 011 ????? 00010 11", mewmul   , V, );
    INSTPAT("000010 ? ????? ????? 100 ????? 00010 11", mewmul   , V, );
